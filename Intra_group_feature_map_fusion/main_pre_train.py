...
class TrainModel():
    def __init__(self, model, dataset, datasets_len, pyramid_f): #cluster_id
        ...
        self.pre_train_dir = os.path.join(self.save_dir, 'pre_train_model')
        self.pre_train_filename = 'FusionModel_40_14_acc0.9539.pt'
    ...
    def _build_pre_train_model(self, ):
        pre_train_filepath = os.path.join(self.pre_train_dir, self.pre_train_filename)
        self.model.load_state_dict(torch.load(pre_train_filepath))
    ...
    def _test_best_model(self, phase):
        # import pdb; pdb.set_trace()
        # print(pnhase, '--')
        start = time.time()
        running_loss, running_corrects = .0, .0
...
if __name__ == '__main__':
    ...
    for pyramid in [2]:  #1, 2,3
        ...
        for i in range(1):
            ...
            train_model._build_pre_train_model()
            train_model.train_model()
            train_model._test_best_model('test')
